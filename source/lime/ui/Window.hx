	...
	**/
	...
	@:noCompletion private function new(application:Application, attributes:WindowAttributes) {
		...
		var mappings = [
			...
			"030000009b2800008000000000000000,DJ Hero Turntable - right-sided (Raphnet),platform:Windows,a:b3,b:b4,x:b5,y:b6,back:b7,start:b8,dpup:-a1,dpdown:+a1,dpleft:-a0,dpright:+a0,lefty:a3~,rightx:a5,righty:a2~,"
		];
